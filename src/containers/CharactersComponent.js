...
let CharactersComponent = ({ characters, fetchCharacterById }) => (
  <Row style={{margin: '0 auto', padding: 20}}>
  {characters ?
  characters.map((item,id) => {
    return (
      <Card  key={id} style={{ justifyContent: 'center', alignItems:'center',  width: '300px', margin: '20px auto ', border:'1px solid #a4a4a4', padding: 10, borderRadius: 4}}>
